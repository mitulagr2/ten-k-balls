...
*/
export function main(window_width: number, window_height: number): void;
...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0afb550510bf0f17: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__he04ced766ada9041: (a: number, b: number) => void;
